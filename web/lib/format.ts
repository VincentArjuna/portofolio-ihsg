...
// Shares: up to 4 decimals, trailing zeros stripped (issue #16 fractional shares).
const sharesFmt = new Intl.NumberFormat("id-ID", {
...
export const formatShares = (n: number) => sharesFmt.format(n);
